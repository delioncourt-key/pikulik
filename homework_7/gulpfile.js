...
const path_to_main_scss_file = './scss/style.scss'; // путь до главного scss файла
const scss_path_to_watch = './scss/*.scss'; // наблюдать за изменениями во всех папках в папке 'styles', scss с любым именем файла
...
function sync() {
    ...
    gulp.watch(scss_path_to_watch, build_sass);
    gulp.watch("./*.html").on('change', browserSync.reload);
}
